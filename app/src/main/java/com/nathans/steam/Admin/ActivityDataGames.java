...
public class ActivityDataGames extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_games);
        mRequestQueue = Volley.newRequestQueue(this);
        pDialog = new ProgressDialog(this);
        pDialog.setCancelable(false);
        list = (ListView) findViewById(R.id.array_list);
        newsList.clear();
        adapter = new AdapterGames(ActivityDataGames.this, newsList);
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        ...
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            ...
                                            Intent a = new Intent(ActivityDataGames.this, EDGame.class);
    ...
    public void onBackPressed() {
        Intent i = new Intent(ActivityDataGames.this, HalamanAdmin.class);
        startActivity(i);
        finish();
    }
